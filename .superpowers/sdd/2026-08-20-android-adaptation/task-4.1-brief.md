...
**Files:**
- Create: `tests/android/sw-enhancement.test.js`
...
Run: `npm test -- tests/android/sw-enhancement.test.js`
Expected: PASS (9 tests)

- [ ] **Step 3: Commit**

```bash
git add tests/android/sw-enhancement.test.js
git commit -m "test: add Android SW caching strategy tests"
```
